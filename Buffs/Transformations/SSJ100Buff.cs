...
{
    internal class SSJ100Buff : Transformation
    {
        ...
        public override bool CanTransform(Player player)
        {
            ...
            return !player.HasBuff<SSJ100Buff>() && modPlayer.SSJ100Achieved;
        }

        public override string FormName() => "Super Saiyan 100";
        ...
        {
            player.GetModPlayer<BUPPlayer>().SSJ100Active = true;
        }

        public override void PostTransform(Player player)
        {
            player.GetModPlayer<BUPPlayer>().SSJ100Active = false;
        }
