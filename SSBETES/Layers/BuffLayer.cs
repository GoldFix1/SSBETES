...
namespace SSBETES.Model
{
    public class BuffLayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            if (player.SSBEActive && BalanceConfig.Instance.UseHair)
            {
                ...
                DrawData dataBody = new DrawData(ModContent.Request<Texture2D>("SSBETES/Assets/SSBEBody", AssetRequestMode.AsyncLoad).Value,
                ...
                DrawData dataArms = new DrawData(ModContent.Request<Texture2D>("SSBETES/Assets/SSBEArms", AssetRequestMode.AsyncLoad).Value,
